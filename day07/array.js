...
// console.log(array5); // console.log(array5[1]) : 9999 가져오기

// .join() , array
// let phoneNumber = array5.join(""); // "" : 쉼표 없애기
...
// console.log(arr4.splice(3, 0, 10)) // 인덱스 3번 자리(4)를 10으로 변경 ?????
// console.log(arr4.splice(4, 1, 50)) // 인덱스 4번 자리(5) 1개를 50으로 변경
// console.log(arr4)
...
// let result = arr6.map((data, i , datas) => data + 10 ) // 중괄호 생략하면 통째로 return 값
// console.log(result);
